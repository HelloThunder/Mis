...
$sql = " CREATE TABLE `addstudent`.`student` ( `Id` INT NOT NULL  PRIMARY KEY,`Name` VARCHAR(30) NOT NULL , `Dob` DATE NOT NULL , `Gender` VARCHAR(10) NOT NULL , `Cast` VARCHAR(15) NOT NULL , `Category` VARCHAR(10) NOT NULL , `Branch` VARCHAR(20) NOT NULL , `Mobile` INT NOT NULL , `Email` VARCHAR(30) NOT NULL , `Address` VARCHAR(75) NOT NULL , `State` VARCHAR(10) NOT NULL , `Country` VARCHAR(10) NOT NULL , `Sem` INT NOT NULL ) ";
