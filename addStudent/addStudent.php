...
$sql = "INSERT INTO `student` ( `Name`, `Dob`, `Gender`, `Cast`, `Category`, `Branch`, `Mobile`, `Email`, `Address`, `State`, `Country`, `Sem`) VALUES ( '$name', '$birth', '$gender', '$cast', ' $category', '$branch', '$mobile', '$email', '$address', '$state', '$country', '$sem')";
