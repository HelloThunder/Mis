...
//  echo var_dump($id);
    $updatequery = "UPDATE `student` SET Name = '$name',Dob='$birth',Gender='$gender',Cast='$cast' ,Category= '$category',Branch='$branch',Mobile='$mobile',Email='$email',Address='$address',State='$state',Country='$country',Sem = '$sem'  WHERE Id = '$id' ";
                 ...
                 <div>
                        ...
                        <div class="row row-space">
                          <!-- Branch -->
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1 " type="text" placeholder="BRANCH" name="branch" value="<?php echo $query['Branch']; ?>">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                <input class="input--style-1 " type="number" placeholder="SEMISTER" name="sem" value="<?php echo $query['Sem']; ?>" min="1" max="8" required>
